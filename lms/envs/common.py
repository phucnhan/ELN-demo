...
ANALYTICS_DASHBOARD_NAME = 'Trainficient E-Learning Insights'
...
RATELIMIT_ENABLE = True # Temporarily disable for testing

# .. setting_name: RATELIMIT_RATE
# .. setting_default: 600/m
